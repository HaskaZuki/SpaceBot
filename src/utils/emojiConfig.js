/**
 * SpaceBot Custom Emoji Configuration
 * 
 * Format: <a:name:ID> for animated, <:name:ID> for static
 * Update the IDs here when emojis are changed in the server
 */
...
module.exports = {
    ...
    // Helper for source icons with fallback
